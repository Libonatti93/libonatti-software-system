const translations = {
  pt: {
    ...
    heroLine1: "Eu construo software",
    heroLine2: "que trabalha de verdade.",
    heroIntro: "Engenheiro de software e desenvolvedor full stack criando produtos digitais, sistemas e automações que transformam complexidade em resultado.",
    aboutLabel: "Quem sou",
    aboutLead: "Sou Matheus Libonatti, engenheiro de software. Transformo ideias em produtos digitais sólidos — da arquitetura à experiência final.",
    photoPlaceholder: "Sua foto entrará aqui",
    aboutText: "Trabalho entre estratégia, tecnologia e produto. Gosto de entender o problema antes de escolher a ferramenta, construir com clareza e entregar soluções que continuem boas quando o negócio crescer.",
    baseLabel: "Base",
    focusLabel: "Foco",
    languagesLabel: "Idiomas",
    servicesLabel: "O que eu faço",
    servicesTitle: "Engenharia que transforma ambição em produto.",
    servicesIntro: "Da primeira conversa ao software em produção, cada decisão existe para gerar impacto, confiança e velocidade.",
    service1Title: "Produtos & Plataformas",
    service1Text: "Aplicações web rápidas, acessíveis e preparadas para evoluir.",
    service2Title: "APIs & Integrações",
    service2Text: "Serviços confiáveis que conectam sistemas, equipes e dados.",
    service3Title: "Automação & IA",
    service3Text: "Fluxos inteligentes para reduzir tarefas e aumentar capacidade.",
    service4Title: "Arquitetura & Consultoria",
  ...
  es: {
    ...
    heroLine1: "Construyo software",
    heroLine2: "que funciona de verdad.",
    heroIntro: "Ingeniero de software y desarrollador full stack creando productos digitales, sistemas y automatizaciones que convierten la complejidad en resultados.",
    aboutLabel: "Quién soy",
    aboutLead: "Soy Matheus Libonatti, ingeniero de software. Transformo ideas en productos digitales sólidos — desde la arquitectura hasta la experiencia final.",
    photoPlaceholder: "Tu foto estará aquí",
    aboutText: "Trabajo entre estrategia, tecnología y producto. Primero entiendo el problema, después elijo la herramienta y construyo soluciones claras que siguen funcionando cuando el negocio crece.",
    baseLabel: "Base",
    focusLabel: "Enfoque",
    languagesLabel: "Idiomas",
    servicesLabel: "Lo que hago",
    servicesTitle: "Ingeniería que convierte ambición en producto.",
    servicesIntro: "Desde la primera conversación hasta el software en producción, cada decisión busca impacto, confianza y velocidad.",
    service1Title: "Productos & Plataformas",
    service1Text: "Aplicaciones web rápidas, accesibles y preparadas para evolucionar.",
    service2Title: "APIs & Integraciones",
    service2Text: "Servicios confiables que conectan sistemas, equipos y datos.",
    service3Title: "Automatización & IA",
    service3Text: "Flujos inteligentes para reducir tareas y aumentar capacidad.",
    service4Title: "Arquitectura & Consultoría",
  ...
  en: {
    ...
    heroLine2: "that actually works.",
    heroIntro: "Software engineer and full-stack developer building digital products, systems and automations that turn complexity into results.",
    aboutLabel: "About me",
    aboutLead: "I'm Matheus Libonatti, a software engineer. I turn ideas into solid digital products — from architecture to the final experience.",
    photoPlaceholder: "Your photo will go here",
    aboutText: "I work at the intersection of strategy, technology and product. I understand the problem before choosing the tool, build with clarity, and deliver solutions that stay strong as the business grows.",
    baseLabel: "Based",
    focusLabel: "Focus",
    languagesLabel: "Languages",
    servicesLabel: "What I do",
    servicesTitle: "Engineering that turns ambition into product.",
    servicesIntro: "From the first conversation to production software, every decision is made for impact, confidence and speed.",
    service1Title: "Products & Platforms",
    service1Text: "Fast, accessible web applications designed to evolve.",
    service2Title: "APIs & Integrations",
    service2Text: "Reliable services connecting systems, teams and data.",
    service3Title: "Automation & AI",
    service3Text: "Smart workflows that reduce busywork and expand capacity.",
    service4Title: "Architecture & Consulting",
